...
\setcounter{tocdepth}{2} % Imposta la profondità dell'indice (3 = subsubsection)
...
\input{titlepage.tex} % PAGINA FRONTESPIZIO
\input{dedication.tex} % PAGINA DEDICA
...
\input{chapters/as-is/as-is.tex}

\input{chapters/architectural-redesign/architectural-redesign.tex}

\input{chapters/implementation/implementation.tex}

\chapter{Migrations}
\begin{itemize}
    \item Planning and execution of a full migration of databases and other company services / platforms that use SRP;
    \item Strategies to minimize downtime and ensure data integrity during the migration process
    \item Strategies to ensure backward compatibility during the transition period
    \item Strategies to ensure a smooth co-existence of the two systems during the transition period
\end{itemize}
