...
Despite this complexity, the REST service returns only a JSON document like the one shown in Listing \ref{lst:example-srp-field-data-0}.
...
\end{minted}
\caption{Example of field data returned by legacy SRP System REST Service.}
\label{lst:example-srp-field-data-0}
\end{listing}
