...
The LLM generates a JSON response following the prompt template structure, which undergoes cleaning and validation before being returned to the client. The cleaning process, shown in Listing \ref{lst:response_cleaning}, handles various formatting artifacts that LLMs commonly produce.
