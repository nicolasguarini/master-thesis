...
A major innovation of this work is the implementation of an intelligent recommendation system. As the service catalog expanded to over 400 distinct actions, traditional hierarchical navigation became a source of cognitive load for users. This thesis introduces a Retrieval Augmented Generation (RAG) solution using an on-premise Large Language Model (GPT-OSS-120b), allowing users to discover services using natural language with transparent reasoning to ensure trust and explainability.
